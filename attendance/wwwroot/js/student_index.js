...
function loadTables(startPage, pageSize) {
    ...
    $.ajax({
        type: "GET",
        url: "/student/list?startPage=" + startPage + "&pageSize=" + pageSize + "&_t=" + new Date().getTime(),
        dataType: "json",
        success: function (data) {
            $.each(data, function (i, item) {
                ...
                tr += "<td>" + (item.gender == null ? "" : item.gender) + "</td>";
                tr += "<td>" + (item.departmentId == null ? "" : item.departmentId) + "</td>";
                tr += "<td>" + (item.classId == null ? "" : item.classId) + "</td>";
                tr += "<td>" + (item.birthDate == null ? "" : item.birthDate) + "</td>";
                tr += "<td>" + (item.native == null ? "" : item.native) + "</td>";
                tr += "<td>" + (item.mobile == null ? "" : item.mobile) + "</td>";
